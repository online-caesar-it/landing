export const promoItems = [
	{
		...
		linkLabel: 'посмотреть пример проекта',
	},
	{
		id: 2,
		title: 'доступ',
...
export const childLearningItems = [
	...
	{
		text: 'уверенно и грамотно строить свою речь. побороть страх перед публикой',
		icon: '/images/learningPerson.png',
		pb: 16,
	},
	{
