...
export const OurFeaturesCard = (props: OurFeaturesCardProps) => {
	...
	return (
		<MotionDiv
			delay={+`0.${number + 1}`}
			sideAnimation
			className='relative w-[44%] bg-linear-card-red mb-[65px] rounded-[50px] pt-[3.6%] pb-[3.6%] px-[4.3%] min-h-[420px] flex flex-col justify-between lg:rounded-[25px] lg:w-[49%] lg:mb-[28px] lg:p-[20px] md:w-full md:min-h-[340px] md:aspect-auto md:p-[24px] md:mb-2'
		>
